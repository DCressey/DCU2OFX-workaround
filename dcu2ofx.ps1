<#
.NOTES
    Script:  dcu2ofx                  Rev:  1.2
    Author:  dcressey                 Date: 4/29/22

 Known Issues:
     negative numbers with parentheses haven't been tested.
     fitids are artificially generated.
     Category field not included.
     Loan, credit, and Savings untested
     Questionable sign on Credit and Loan transactions.
     Note that Credit and Debit are oppositely named from checking
     Header and trailer needs to be verified in detail.
...
$menu = @{
    ...
    CREDIT   = 'Process Credit Card Transactions'
